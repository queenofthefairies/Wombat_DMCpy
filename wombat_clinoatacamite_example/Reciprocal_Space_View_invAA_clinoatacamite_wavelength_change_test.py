...
PRETENDING WAVELENGTH IS 1.54 ANGSTROM JUST TO TEST FUNCTIONALITY
"""
import sys
...
sample_name = 'clinoatacamite_wavelength_test' 
...
df = WombatDataFile.loadWombatDataFile(file_path,
                                       ...
                                       wavelength=1.54, # Wavelength in angstroms JUST TESTING IT WORKS FOR SOMETHING OTHER THAN 2.41 ANGSTROMS
