...
Dataset = PMT diffuse feasibility 2025-04-10
2p41 Angstrom data
"""
import sys
...
q1 = [-1.061,0.347,-0.075]
q2 = [-3.1105,-0.6192,-0.191]
HKL1 = [0,3,1]
HKL2 = [0,9,-1]
...
# with this choice of p1 and p2 we will get the hk0 plane
p1 = np.array([0,1,0])
p2 = np.array([0,0,1])
ds.setProjectionVectors(p1,p2,p3=None)
plane_name = '0kl' # name for the plane

# Run the reciprocal space viewer, Viewer3D
Viewer = ds.Viewer3D(0.02, 0.02, 0.02, rlu = True)

# Set the color bar limits to 0 and 0.00005
Viewer.set_clim(0,0.00005)
